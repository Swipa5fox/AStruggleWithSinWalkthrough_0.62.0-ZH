...
1. 要进入其中，首先你需要用一瓶葡萄酒贿赂靠近 Arenfield 桥边的守卫。
...
5. 进入宅邸前：避免被守卫或宅邸里的人发现。如果你完成了 **Emily** 的任务，可以选择穿上强盗伪装，这样可以避免被抓时遭受惩罚，但这会让宅邸进入警戒状态；被抓之后需要等一天才能一切恢复正常。如果你未伪装就被抓，你在 Arenfield 的名誉会下降并被关押一天。
...
8. 上去进入 **Giron** 的办公室，在书架里你现在也可以使用"留下"的选项。进去之后，按回车键或点击它进行互动。
...
你可以把仆人卧室里的葡萄酒换成精液酒（用葡萄酒瓶+精液瓶制作）来腐化 **Julia**。午夜时分，**Julia** 会去喝酒，堕落值会 +1，等她这样做了 5 次之后，她会在上床前与 **Joseph** 发生性关系（仅当你在与 **Yasmine** 的对话中拒绝过 **Julia** 的恋爱选项时才会触发）。
